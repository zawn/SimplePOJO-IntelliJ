...
//        }
    ...
    public static <String, E> Map<String, List<Node>> groupBy(final NodeList iterable, final Function<Node, String> func) {
    ...
    public XClass visitClass(Node node) {
        ...
        Map<String, List<Node>> grouped = groupBy(node.getChildNodes(), new Function<Node, String>() {
